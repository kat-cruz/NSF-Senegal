*** DISES Baseline Data Checks - April version***
*** File Created By: Molly Doruska ***
*** File Last Updated By: Molly Doruska ***
*** File Last Updated On: June 10, 2024 ***
...
global community "$master\Data Quality Checks\April Output\Community_Issues"
global issues "$master\Data Quality Checks\April Output\Full Issues"

global data "$master\Surveys\Baseline CRDES data (April 2024)"

*** import community survey data ***
import delimited "$data\Questionnaire Communautaire - NSF DISES_V2_WIDE_10June24.csv", clear varnames(1) bindquote(strict)
...
*export excel using "$issues\Community_Issues_26April24.xlsx", firstrow(variables)  
