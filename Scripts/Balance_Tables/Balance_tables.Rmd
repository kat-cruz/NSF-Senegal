...
index3 <- which(final_table$variable == "hh_13_1_")
...
final_table <- final_table %>%
  mutate(Question = case_when(
    variable == "hh_age_resp" ~ "Age of the Respondent",
    variable == "hh_gender_" ~ "Gender",
    variable == "hh_age_" ~ "Age",
    variable == "hh_education_skills" ~ "Education - Skills (multiple choice)",
    ...
    variable == "hh_13_1_" ~ "\u00A0\u00A0\u00A0Hours spent fetching water for the household",
    variable == "hh_13_2_" ~ "\u00A0\u00A0\u00A0Hours spent giving water to livestock",
    variable == "hh_13_3_" ~ "\u00A0\u00A0\u00A0Hours spent fetching water for agriculture",
    variable == "hh_13_4_" ~ "\u00A0\u00A0\u00A0Hours spent washing clothes",
    variable == "hh_13_5_" ~ "\u00A0\u00A0\u00A0Hours spent washing the dishes",
    variable == "hh_13_6_" ~ "\u00A0\u00A0\u00A0Hours spent harvesting aquatic vegetation",
    variable == "hh_13_7_" ~ "\u00A0\u00A0\u00A0Hours spent simming/bathing",
    #variable == "hh_13_8" ~ "Hours spent playing in the water ",
    ...
    variable == "health_5_3_" ~ "What type of illness or injury did he/she suffer from?",
    ...
    variable == "agri_income_05" ~ "Responded yes to agri_income_01; Amount received in kind and/or in cash for this work.",
    ...
    variable == "living_04_2" ~ "\u00A0\u00A0\u00A0Flush with sewe",
    ...
    variable == "living_05" ~ "Main fuel used for cooking",
    ...
    variable == "enum_03" ~ "(Enumerator observation) Main materials used for the roof of the house",
    ...
    variable == "enum_04" ~ "(Enumerator observation) Main materials used for the walls of the house where the head of the family sleeps?",
    ...
    variable == "enum_05" ~ "(Enumerator observation) Main materials of the main floor of the house",
...
knitr::kable(final_table, format = "html") %>% save_kable("final_table.html")
