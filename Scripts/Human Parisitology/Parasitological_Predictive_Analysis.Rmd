...
binary_df <- matched_only_df %>%
  mutate(
    # For hh_19_
    hh_19_1 = if_else(hh_19_ == 1, 1, 0),
    hh_19_2 = if_else(hh_19_ == 2, 1, 0),
    hh_19_3 = if_else(hh_19_ == 3, 1, 0),
    hh_19_4 = if_else(hh_19_ == 4, 1, 0),
    hh_19_99 = if_else(hh_19_ == 99, 1, 0),

    # For hh_31_
    hh_31_1 = if_else(hh_31_ == 1, 1, 0),
    hh_31_2 = if_else(hh_31_ == 2, 1, 0),
    hh_31_3 = if_else(hh_31_ == 3, 1, 0),
    hh_31_4 = if_else(hh_31_ == 4, 1, 0),
    hh_31_5 = if_else(hh_31_ == 5, 1, 0),

    # For hh_33_
    hh_33_1 = if_else(hh_33_ == 1, 1, 0),
    hh_33_2 = if_else(hh_33_ == 2, 1, 0),
    hh_33_3 = if_else(hh_33_ == 3, 1, 0),
...
```{r}
# Define possible paths
path1 <- "C:/Users/Kateri/Downloads/SenegalGIT/Repo/Latex_Output/Parasitological_Predictive_Analysis"
path2 <- "C:/Users/km978/Downloads/SenegalGIT/Repo/Latex_Output/Parasitological_Predictive_Analysis"
...
mutate(
  Survey_Question = case_when(
    str_detect(Variable, "^q_18") ~ "Educational facilities",
    str_detect(Variable, "^q_19") ~ "Health facilities",
    str_detect(Variable, "^q_23") ~ "Running drinking water for drinking",
    str_detect(Variable, "^q_24") ~ "Of those with running water, do you have a tap water system",
    str_detect(Variable, "^q_35_check") ~ "Was there any deworming treatment carried out by the Ministry of Health or another organization?",
    str_detect(Variable, "^q_39") ~ "In the village, are there currently any ongoing projects aimed at reducing the prevalence of bilharzia?",
    str_detect(Variable, "^schisto_indicator") ~ "Snails found with schisto",
