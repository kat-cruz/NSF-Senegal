...
additional_cols_to_drop <- c(
  ...
  grep("^health_5_3_o", names(tables_df), value = TRUE),
...
tables_df_long <- tables_df %>%
  pivot_longer(
    cols = starts_with("hh_gender_") | 
           starts_with("hh_age_") | 
           starts_with("hh_education_skills_") |
           starts_with("health_5_3_") | 
           starts_with("hh_12_") | 
           starts_with("hh_13_") | 
           starts_with("hh_education_level_") | 
           starts_with("hh_education_year_achieve_") | 
           starts_with("hh_number_") | 
           starts_with("hh_03_") | 
           starts_with("hh_10_") | 
           starts_with("hh_11_") | 
           starts_with("hh_14_") | 
           ...
           starts_with("hh_16_") | 
           starts_with("hh_29_") | 
           starts_with("health_5_2_") | 
           starts_with("health_5_3_") | 
           starts_with("health_5_5_") | 
           starts_with("health_5_6_") | 
           starts_with("health_5_7_"),
    names_to = "id",  # Corresponds to `j(id)` in Stata
    values_to = "value"  # The long-format values
  )
