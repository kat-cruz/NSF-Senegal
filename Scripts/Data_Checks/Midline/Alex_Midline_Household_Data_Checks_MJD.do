...
**** GLOBALS: to update with correct number for each index to make sure loops work correctly ****** 
global mems = 57 
global actifs = 15
global agriequip = 8
global parcels = 9
global species = 7 
global animalsales = 6 
global activity = 5
global credit = 6 
global loans = 1
global products = 15
...
***	xiii.	hh_12_o should be answered when hh_12_999 = 1, should be text ***    /// PROBLEM
...
*** xix. agri_income_12_o should be answered when animals_sales_o = 1, should be between 0 and 100000000 ***
...
*** xxi.	agri_income_14_ o should be answered animals_sales_o = 1, should be between 0 and 100000000
...
preserve 
	...
	*** generate indicator variable ***
	gen ind_var = 0 
	replace ind_var = 1 if agri_income_14_o < 0 | agri_income_14_o > 100000000
...
forvalues i 1 = 1/$activity {	

preserve
    
	keep if agri_income_21_h_`i' < 0 | agri_income_21_h_`i' > 50 & agri_income_21_h_`i' != .
	
	generate issue = "Unreasonable value"
	generate issue_variable_name = "agri_income_21_h_`i'"
	rename agri_income_21_h_`i' print_issue 
	tostring(print_issue), replace
	keep villageid hhid sup enqu sup_name enqu_name hh_phone hh_name_complet_resp hh_name_complet_resp_new issue_variable_name issue print_issue
	if _N > 0 {
		save "$income\Issue_agri_income_21_h_`i'", replace
}
	...
	keep if agri_income_21_f_`i' < 0 | agri_income_21_f_`i' > 50 & agri_income_21_f_`i' != .
	
	generate issue = "Unreasonable value"
	generate issue_variable_name = "agri_income_21_f_`i'"
	rename agri_income_21_f_`i' print_issue 
	tostring(print_issue), replace
	keep villageid hhid sup enqu sup_name enqu_name hh_phone hh_name_complet_resp hh_name_complet_resp_new issue_variable_name issue print_issue
	if _N > 0 {
		save "$income\Issue_agri_income_21_f_`i'", replace
}
...
preserve
	...
	keep if agri_income_21_h_o < 0 | agri_income_21_h_o > 50 & agri_income_21_h_o != .
	...
	keep villageid hhid sup enqu sup_name enqu_name hh_phone hh_name_complet_resp hh_name_complet_resp_new issue_variable_name issue print_issue
	if _N > 0 {
		save "$income\Issue_agri_income_21_h_o", replace
}
...
preserve
	...
	keep if agri_income_21_f_o < 0 | agri_income_21_f_o > 50 & agri_income_21_f_o != .
	...
	keep villageid hhid sup enqu sup_name enqu_name hh_phone hh_name_complet_resp hh_name_complet_resp_new issue_variable_name issue print_issue
	if _N > 0 {
		save "$income\Issue_agri_income_21_f_o", replace
}
...
preserve
    keep if agri_income_22_`i'  != . & agri_income_22_`i' > 12
	generate issue = "Unreasonable value"
	generate issue_variable_name = "agri_income_22_`i'"
	rename agri_income_22_`i' print_issue 
	tostring(print_issue), replace
	keep villageid hhid sup enqu sup_name enqu_name hh_phone hh_name_complet_resp hh_name_complet_resp_new issue_variable_name issue print_issue
	if _N > 0 {
		save "$income\Issue_agri_income_22_`i'", replace
}
 restore
}

preserve
    keep if agri_income_22_o  != . & agri_income_22_o > 12
	generate issue = "Unreasonable value"
	generate issue_variable_name = "agri_income_22_o"
	rename agri_income_22_o print_issue 
	tostring(print_issue), replace
	keep villageid hhid sup enqu sup_name enqu_name hh_phone hh_name_complet_resp hh_name_complet_resp_new issue_variable_name issue print_issue
	if _N > 0 {
		save "$income\Issue_agri_income_22_o", replace
}
restore
