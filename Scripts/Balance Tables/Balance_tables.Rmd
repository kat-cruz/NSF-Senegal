...
#                      "hh_14_",
#                      "hh_16_",
#                      select(matches("^hh_education_skills_[0-9]+$")),  
#                      select(matches("^hh_education_level_[0-9]+$")),  
#                      select(matches("^hh_11_[0-9]+$")), 
#                      select(matches("^hh_15_[0-9]+$")), 
#                      select(matches("^hh_13_[0-9]+$")), 
#                      select(matches("^living_01_[0-9]+$")), 
#                      select(matches("^living_03_[0-9]+$")), 
#                      select(matches("^living_04_[0-9]+$")), 
#                      select(matches("^living_05_[0-9]+$")), 
#                      select(matches("^enum_03_[0-9]+$")),  
#                      select(matches("^enum_04_[0-9]+$")), 
#                      select(matches("^enum_05_[0-9]+$")),
#                                           ) 
# household_id <- "hhid"  
# 
# # Filter rows to keep only 1s and 0s in the specified variables
