...
packages <- c("clusterSEs", "mlogit", "writexl", "dplyr", "readr", "tidyr", 
              ...
              "sandwich", "lmtest", "stats", "nnet", "car", "aod")
...
summary_table3 <- summary_table2 %>%
  mutate(Question = case_when(
    ...
    variable == "hh_16_" ~ "Hours spent producing, purchasing, or applying fertilizer, among those who spent time near a water source",
...
symbol = c(
  ...
  save_kable("_baseline_summary_statsV3.html")
...
# Save to Excel
write_xlsx(summary_table_with_footnotes, "_baseline_summary_statsV5.xlsx")
...
final_table %>%
  ...
  save_kable("balance_tablev_jointf_2.html")
##balance_tablev11.html = without -9s
```
#####excel output
...
write_xlsx(final_table, "balance_tablev_jointf_2.xlsx")
