...
import excel using "$corrected\CORRECTED_DISES_Principal_Survey_MIDLINE_VF_WIDE_24Feb2025.xlsx", firstrow
...
** KRM - use loop below to append faster if you would like !
	...
	save "$schoolprincipal\Schoolprincipal_Issues_24Feb2025.dta", replace // keep record of all the issues for each cleaning to filter

sort sup_name

* Export to Excel
export excel using "$schoolprincipal\SchoolPrincipal_Issues_24Feb2025.xlsx", firstrow(variables) replace  
