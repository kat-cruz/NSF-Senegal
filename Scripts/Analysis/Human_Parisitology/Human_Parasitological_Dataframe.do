...
global partner_raw "${master}\Data_Management\_Partner_RawData"
global partner_clean "${master}\Data_Management\_Partner_CleanData"

global crdes_data "${master}\Data_Management\_CRDES_CleanData"
global eco_data "${master}\Data_Management\_Partner_RawData\Ecological_Data\Baseline"


***** Global folders *****
global raw_data  "${partner_raw}\UCAD_Data"
global clean_data  "${partner_clean}\Child_Matches"
global output "${master}\Data_Management\Output\Data_Analysis\Parasitological_Analysis_Data\Analysis_Data"
...
save "${output}\child_infections.dta", replace
...
use "${output}\child_infections.dta", clear
...
save "${output}\child_infection_dataframe.dta", replace
