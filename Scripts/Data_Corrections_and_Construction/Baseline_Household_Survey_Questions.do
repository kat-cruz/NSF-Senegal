*** DISES Baseline Data Checks Houseold Survey Question file ***
*** File originally created By: Kateri Mouawad  ***
*** Updates recorded in GitHub ***

*>>>>>>>>>>*===========================* READ ME *===========================*<<<<<<<<<<<*
			*GENERAL COMMENT: this is not efficient - just messed around to get it to work 

			*1)	This generates a dataframe that contains the survey variable names and their coresponding survey questions 
			*2)	This is used for future analysis of baseline data that require survey questions in the output 
...
global output = "$master\Data_Management\Output\Data_Analysis\Balance_Tables"
...
*** Public Goods Games ***
	gen game_intro = "Avant d'entrer dans la maison, lancez une piece de monnaie. Notez le resultat ici"
	gen game_01 = "Y a-t-il des questions"
	gen game_02 = "Veuillez indiquer si vous etes pret a jouer a ce jeu"
	gen consent_game_1 = "Pourriez-vous s'il vous plaît reconnaitre que vous avez recu 1200 FCFA"
	gen montant_02 = "Montant verse par le repondant pour le jeu A"
	gen game_03 = "Y a-t-il des questions"
	gen montant_05 = "Montant verse par le repondant pour le jeu B"
	gen montant_07 = "Si le montant verse par le repondant pour le jeu B est inferieur a 200 : Pourriez-vous s'il vous plait reconnaitre que vous avez recu 1000 FCFA"
	gen montant_08 = "Si le montant verse par le repondant pour le jeu B est d'au moins a 200 : Pourriez-vous s'il vous plait reconnaitre que vous avez recu 1200 FCFA"
	gen face_01 = "Y a-t-il des questions"
	gen face_02 = "Veuillez indiquer si vous etes pret a jouer a ce jeu"
	gen face_04 = "Montant verse par le repondant pour le jeu B"
	gen face_06 = "Si le montant verse par le répondant pour le jeu B est inferieur a 200 : Pourriez-vous s'il vous plait reconnaitre que vous avez recu 1000 FCFA"
	gen face_07 = "Si le montant verse par le répondant pour le jeu B est d'au moins a 200 : Pourriez-vous s'il vous plait reconnaitre que vous avez reçu 1200 FCFA"
	gen face_09 = "Y a-t-il des questions"
	gen face_10 = "Veuillez indiquer si, compte tenu de ces instructions, vous etes pret a jouer a ce jeu"
	gen face_11 = "Pourriez-vous s'il vous plait reconnaitre que vous avez recu 1200 FCFA"
	gen face_13 = "Montant verse par le repondant pour le jeu A"
...
foreach var of local varlist {
    local var_value = `var'  // Get value of the variable
    post `temp' ("`var'") ("`var_value'")
}
...
** KRM - I'm using these for the balance tables, so renaming for easy merge in the Balance_tables R markdown located here:
 **  "SenegalGIT\Repo\Scripts\Balance_Tables\Balance_tables.Rmd"
 
rename variable_name variable

save "$output\Baseline_Survey_Questions.dta", replace 
export delimited using "$output\Baseline_Survey_Questions.csv", replace
