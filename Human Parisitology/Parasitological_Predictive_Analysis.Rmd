...
errors <- sapply(thresholds, function(t) {
  ...
  confusion_matrix <- table(Predicted = predictions, Actual = matched_only_df$actual_infection_status)
...
confusion_matrix_optimal <- table(Predicted = predictions_optimal, Actual = matched_only_df$actual_infection_status)
