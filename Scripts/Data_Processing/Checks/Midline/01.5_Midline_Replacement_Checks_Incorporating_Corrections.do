...
global data "$master\Data_Management\Data\_CRDES_RawData\Midline\Replacement_Survey_Data"
global corrected "$master\Data_Management\Output\Data_Processing\Checks\Corrections\Midline"

**************************** output file paths ****************************
global replacement_survey "$master\Data_Management\Output\Data_Processing\Checks\Midline\Midline_Replacement_Survey"
...
export delimited using "$corrected\CORRECTED_DISES_enquete_ménage_FINALE_MIDLINE_REPLACEMENT_WIDE_10April2025.csv", replace

save "$corrected\CORRECTED_DISES_enquete_ménage_FINALE_MIDLINE_REPLACEMENT_WIDE_10April2025.dta", replace
