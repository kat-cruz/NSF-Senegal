...
use "$household_roster\Issue_Household_hh_08_2_unreasonable.dta", clear 
...
append using "$household_roster\Issue_hh_29_24.dta"
...
append using "$health\Issue_Household_health_5_9_23.dta"
...
use "$agriculture_production\Issue_legumes_01_1_unreasonable.dta", clear 
...
export excel using "$issuesOriginal\Household_Data_Issues_27Jan2025Test.xlsx", firstrow(variables) replace 
