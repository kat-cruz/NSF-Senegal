...
set matsize 11000
set more off
set obs 10  // Create one observation  
...
**# Bookmark #7 - KRM: not present 
	*gen hh_21_`i'_7 = "Au cours des 7 derniers jours, combien d'heures par semaine en moyenne [hh_full_name_calc] a t-il consacre a hh_20 = 7 pres de (< 1 m) ou dans la/les source(s) d'eau?"
	...
	gen hh_47_a_`i' = "Combien a été dépensé pour l'éducation de [NOM] au cours des 12 derniers mois par le ménage, la famille et les amis : Frais d'inscription et de scolarité ?"
	gen hh_47_b_`i' = "Combien a été dépensé pour l'éducation de [NOM] au cours des 12 derniers mois par le ménage, la famille et les amis : Fournitures ?"
	gen hh_47_c_`i' = "Combien a été dépensé pour l'éducation de [NOM] au cours des 12 derniers mois par le ménage, la famille et les amis : Uniformes ?"
	gen hh_47_d_`i' = "Combien a été dépensé pour l'éducation de [NOM] au cours des 12 derniers mois par le ménage, la famille et les amis : Repas scolaires ?"
	gen hh_47_e_`i' = "Combien a été dépensé pour l'éducation de [NOM] au cours des 12 derniers mois par le ménage, la famille et les amis : Transport scolaire ?"
	gen hh_47_f_`i' = "Combien a été dépensé pour l'éducation de [NOM] au cours des 12 derniers mois par le ménage, la famille et les amis : Cours particuliers ou séances de répétition ?"
