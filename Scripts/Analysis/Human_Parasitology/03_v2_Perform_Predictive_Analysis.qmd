...
format:
  html:
    ...
    theme: default
    output-file: "Parasitological_Analysisv4.html" #MAKE SURE TO UPDATE
execute:
  echo: true
---
...
paras_sum_stats_ad <- paras_sum_stats_ad %>%
  mutate(
    ...
    Source = case_when(
      Variable %in% Variable[match("hh_age_", Variable):match("asset_index_std", Variable)] ~ "CRDES Household Survey",
