...
import delimited "$data\DISES_Enquête_ménage_midline_VF_WIDE_16Feb2025.csv", clear varnames(1) bindquote(strict)
...
forvalues i = 1/57 {
    ...
    *Check if sum of hh_21_i_j and hh_21_o_i is more than sum of hh_18_i
	...
	tostring(print_issue), replace
	keep villageid hhid sup enqu sup_name enqu_name hh_phone hh_name_complet_resp hh_name_complet_resp_new issue_variable_name issue print_issue hh_member_name key hh_18`i' hh_21_o_`i' hh_21_`i'_1  hh_21_`i'_2  hh_21_`i'_3  hh_21_`i'_4  hh_21_`i'_5  hh_21_`i'_6 hh_21_`i'_7
