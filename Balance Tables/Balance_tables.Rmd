...
tables_df <- tables_df  %>%
select(-starts_with(" "), -starts_with(" "), -starts_with(" "), -starts_with(" "), -starts_with(" "), -starts_with(" "), -starts_with(" "), -starts_with(" "), -starts_with(" ")
       )
...
df_long <- df %>%
  pivot_longer(
    cols = starts_with("health_5_"),  # Include all variables starting with "health_5_"
