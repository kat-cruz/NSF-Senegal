...
keep submissiondate starttime endtime duration today hhid_village grappe schoolmosqueclinic grappe_int sup consent_obtain consent_notes respondent_is_director respondent_is_not_director respondent_is_not_director_o start_survey date time respondent_other_role respondent_other_role_o respondent_gender respondent_age director_experience_general director_experience_specific school_water_main school_water_main_o school_distance_river school_children_water_collection school_water_use* school_water_use_o school_reading_french school_reading_local school_computer_access school_meal_program school_teachers school_staff_paid_non_teaching school_staff_volunteers school_council council_school_staff council_community_members council_women council_chief_involvement grade_loop* classroom_count* enrollment_* passing_* attendence_regularly_* absenteeism_problem main_absenteeism_reasons* main_absenteeism_reasons_label* absenteeism_top_reason schistosomiasis_problem peak_schistosomiasis_month schistosomiasis_primary_effect schistosomiasis_sources* schistosomiasis_treatment_minist schistosomiasis_treatment_date
